--===============================================================
--  Caetano Traina Júnior -- março de 2022 ----------- ==========
--  Criar o ESQUEMA para A base de dados sobre Formula 1       ==
--  Tempo aproximado de execução: 13 secs. (Dell-Sol)
/*-------------------------------------------------------------==

AS tabelas sobre Fomrula 1 foram obtidas do site do repositório kaggle de:   https://www.kaggle.com/datasets/rohanrao/formula-1-world-championship-1950-2020
...
PERFORM LoadFile(DirLocal, 'DriverStandings.csv', 'DriverStandings', 'DELIMITER '','', NULL ''\N'', HEADER true, FORMAT CSV');
PERFORM LoadFile(DirLocal, 'Drivers.csv', 'Driver', 'DELIMITER '','', NULL ''\N'', HEADER true, FORMAT CSV');
PERFORM LoadFile(DirLocal, 'LapTimes.csv', 'LapTimes', 'DELIMITER '','', NULL ''\N'', HEADER true, FORMAT CSV');
PERFORM LoadFile(DirLocal, 'PitStops.csv', 'PitStops', 'DELIMITER '','', NULL ''\N'', HEADER true, FORMAT CSV');
